...
We shall be simplifying such binomial coefficients very often so let us recall the following lemma. 
...
As before, we shall first count the number of pairs of monmials $\beta \in \partial_\alpha P$ and $\beta' \in \partial_{\alpha'} P$ such that $\gcd(\beta, \beta') = t$. 
