...
%DIF DEL lb2_old.tex   Mon Sep 29 15:45:26 2014
%DIF ADD lb2.tex       Mon Sep 29 15:42:26 2014
...
%DIF < 
%DIF < 
%DIF < \title{Recent Progress on Arithmetic Circuit Lower Bounds}
%DIF < \author{Ramprasad Saptharishi\\
%DIF < Microsoft Research India\\
%DIF < {\tt ramprasad@cmi.ac.in}
%DIF < }
...
\DIFaddbegin \beatcsColumn{complexity}{It is widely believed that the
...
\title{\DIFadd{Recent Progress on Arithmetic Circuit Lower Bounds}}
\author{\DIFadd{Ramprasad Saptharishi}\\
\DIFadd{Microsoft Research India}\\ {\tt \DIFadd{ramprasad@cmi.ac.in}} }
