...
\section{Depth reduction for arithmetic formulas}
...
\section{Depth reduction for arithmetic circuits}
...
\subsection{Applying Brent's reduction with degree}
...
\subsection{Depth reduction of \cite{vsbr83}}
...
\section{Reduction to depth four circuits}
...
\section*{Reduction to depth three}
...
\section{Depth reduction for formulas, again}
...
We would need the following lemma that was present in the survey of Shpilka and Yehudayoff \cite{sy} and also in the result of Hrube\v{s} and Yehudayoff \cite{HY11a}.

\subsection{Log-product decompositions}
...
Essentially, these log-product decompositions preserve any syntactic restrictions in the original formula (i.e. multilinearity, homogeneity, set-multilinearity, monotonicity etc.). 
